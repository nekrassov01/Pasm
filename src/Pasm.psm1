...
namespace ${moduleName}.Parameter
{
    ...
    public enum NetworkAcl          { ResourceName, VpcId, MaxEntry, FlowDirection, AssociationSubnetId, RuleNumber, Rules }
    ...
    public enum NetworkAclRules     { Id, ServiceKey, Region, Protocol, IpFormat, FromPort, ToPort, EphemeralPort }
